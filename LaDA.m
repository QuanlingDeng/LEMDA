...
mu0 = 0.001*randn(n,1)+0.001i*randn(n,1); 
mu0(1:2*nqq) = 0;
...
npi = 1;
save(['./uhat/LaDAuhat' num2str(npi,'%02.f') '.mat'],"u_post_mean", "u_post_cov");
